...
const LoginScreen = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      <Image
        source={require('../assets/image/kostkuLogo150.png')}
      ...
      <View
        ...
        <View
          style={[
            styles.form,
            {borderColor: usernameError ? 'red' : '#FFB700'},
          ]}>
          <Icon
            size={18}
            name="pencil"
        ...
        <View
          style={[
            styles.form,
            {borderColor: passwordError ? 'red' : '#FFB700'},
          ]}>
          <Icon
            size={18}
            name="lock"
        ...
        <TouchableOpacity
          ...
          <Text style={{color: '#cccccc', fontSize: 13, textAlign: 'right'}}>
            Lupa Password?
          </Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.container}>
        ...
        <View
          ...
          <View
            style={[
              styles.form,
              {borderColor: phoneError ? 'red' : '#FFB700'},
            ]}>
            <Icon
              size={18}
              name="cellphone"
          ...
          <View
            style={[
              styles.form,
              {borderColor: emailError ? 'red' : '#FFB700'},
            ]}>
            <Icon
              size={18}
              name="email-outline"
        ...
        <View style={{marginTop: 20}}>
          ...
          <View
            ...
            <TouchableOpacity onPress={() => syaratDanKetentuan()}>
              <Text style={{color: '#FFB700', fontWeight: 'bold'}}>
                Syarat & Ketentuan
              </Text>
            </TouchableOpacity>
